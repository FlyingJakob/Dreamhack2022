		...
		public void OnGUI()
		{
			...
			GUILayout.BeginHorizontal();
				...
				EditorGUILayout.LabelField(
					"The package you have downloaded from the asset store installed shaders compatible with URP 7.2. " + 
					"In case you got any compilation errors this most likely is caused by the fact that you are using a newer version of URP.\n" + 
